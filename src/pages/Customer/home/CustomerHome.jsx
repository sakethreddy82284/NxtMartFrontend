      ...
      <main className="home-main-scroll">
        ...
        <section className="home-promo-grid animate-fade-up stagger-2">
          <div className="promo-card blue-tint">
            ...
            <img src="https://images.unsplash.com/photo-1550583724-1255818c0533?q=80&w=200&auto=format&fit=crop" alt="Milk" />
          </div>
          <div className="promo-card orange-tint">
            ...
            <img src="https://images.unsplash.com/photo-1599490659223-930b447ffad6?q=80&w=200&auto=format&fit=crop" alt="Snacks" />
          </div>
        </section>
